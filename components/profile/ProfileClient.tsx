...
function ProfileContent({ initialProfile }: { initialProfile?: ProfileData }) {
  ...
  const { data: profile, isLoading, error } = useQuery<ProfileData>({
    ...
    retry: false,
    /*
     * Seeded from the server component so the server-rendered HTML contains
     * the real profile instead of a loading skeleton. Crawlers were previously
     * served an empty shell, which made every public profile worthless for
     * search and for link previews.
     */
